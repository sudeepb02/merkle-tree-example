...
import {WhitelistAbi} from './abis/contractAbis'
// const addresses = require("./data/whitelist_addresses")
...
function Merkle() {
    ...
    const initializeContract = async () => {
        const whitelistContract = new ethers.Contract(whitelistContractAddress, WhitelistAbi, provider.getSigner())
        ...
        // console.log(await whitelistContract.functions.verifyWhitelist(hexProof, positions))
    }
